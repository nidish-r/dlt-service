...
export const storeApiKeyAndSecret = async (apiKey: string, hmacSecret: string): Promise<void> => {
...
export const rotateApiKeyAndSecret = async (existingApiKey: string, newApiKey: string, newHmacSecret: string): Promise<void> => {
